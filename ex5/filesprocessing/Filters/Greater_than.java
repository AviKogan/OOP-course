...
/**
 * Represent the filter of type greater_than.
 */
class Greater_than extends Filter{
    ...
    /**
     * Class constructor, create a filter of type greater_than.
     ...
     *                                valid.
     */
    public Greater_than(String[] filterParts) throws WarningFilterException {
    ...
    public ArrayList<File> filter(ArrayList<File> filesToFilter) {
        ...
        for(File file : filesToFilter){
            ...
            if(!_stateNot && fileSizeInKb > _size || _stateNot && fileSizeInKb <= _size){
                //check whether the file size is strictly greater than _size and no NOT suffix added,
                // or if NOT suffix added and the file smaller or equal than _size
